...
1. **Original Agent** – A basic agent that can answer user queries.
2. **Cloned Agent** – A copy of the original agent with modified instructions for more advanced answers.
3. **Forcing Tool** – The cloned agent is configured to use **only one specific tool** for its answers.
...
* **Math calculations** – Force the agent to use a calculator.
* **Data retrieval** – Force the agent to use a search tool.
* **Translation tasks** – Force the agent to use a translator tool.
