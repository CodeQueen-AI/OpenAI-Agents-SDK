...
Agent Clone ka main kaam hai:

1. **Reusability:** Existing agent ke behavior aur capabilities ko reuse karna.
2. **Customization:** Original agent ke base par ek naya agent banakar uski instructions ya rules modify karna.
...
* Jab aapko **same type ka multiple agent** chahiye, jaise different styles me responses dene ke liye.
